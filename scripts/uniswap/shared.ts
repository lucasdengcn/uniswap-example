...
const tokens: { [name: string]: TokenJson } = {
    "USDT": { abi: artifacts.TETHER.abi, bytecode: artifacts.TETHER.bytecode, address: TETHER_ADDRESS, symbol: "USDT", name: "Tether" },
    "USDC": { abi: artifacts.USDC.abi, bytecode: artifacts.USDC.bytecode, address: USDC_ADDRESS, symbol: "USDC", name: "Usdc" },
    "WBTC": { abi: artifacts.WBTC.abi, bytecode: artifacts.WBTC.bytecode, address: WBTC_ADDRESS, symbol: "WBTC", name: "WBTC" }
};

export { artifacts, tokens, TokenJson }